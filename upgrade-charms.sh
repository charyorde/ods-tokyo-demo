...
juju upgrade-charm --switch cs:~openstack-charmers-next/trusty/ceilometer ceilometer
juju upgrade-charm --switch cs:~openstack-charmers-next/trusty/ceilometer-agent ceilometer-agent
...
juju upgrade-charm --switch cs:~openstack-charmers-next/trusty/hacluster cinder-hacluster
juju upgrade-charm --switch cs:~openstack-charmers-next/trusty/glance glance
juju upgrade-charm --switch cs:~openstack-charmers-next/trusty/hacluster glance-hacluster
juju upgrade-charm --switch cs:~openstack-charmers-next/trusty/heat heat
...
juju upgrade-charm --switch cs:~openstack-charmers-next/trusty/hacluster swift-proxy-hacluster
